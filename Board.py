...
class Board:
    ...
    def isvalid_move(self,from_,to_):
        ...
        # Check if the from and to positions are within bounds and not walls
        ...
        if (row_diff == 1 and col_diff == 0) or (row_diff == 0 and col_diff == 1):
            ...
            # Move skipping one cell vertically or horizontally
            return True
...
b1 = Board()
print(b1.isvalid_move(Board.board_vals['a'],Board.board_vals['c']))
b1.print_board()
